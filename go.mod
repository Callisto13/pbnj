...
replace (
	github.com/bmc-toolbox/bmclib/v2 => /home/claudia/workspace/equinix/bmclib
	github.com/equinix-labs/otel-init-go => /home/claudia/workspace/equinix/otel-init-go
)
